 ...
 * TopShellModule.h
 *
 * Module for showing server stats.
...
#ifndef _OPENCOG_TOP_SHELL_MODULE_H
#define _OPENCOG_TOP_SHELL_MODULE_H
...
class TopShellModule : public Module
{
	private:
	...
	public:
		TopShellModule(CogServer&);
		virtual ~TopShellModule();
...
#endif // _OPENCOG_TOP_SHELL_MODULE_H
